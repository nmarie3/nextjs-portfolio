...
const HistorySvgMask = ({ className }: Props) => (
 <div>
      <svg id="Layer_7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 585.8 218.39" className={className} preserveAspectRatio="xMidYMid meet">
        <motion.path
            initial={{ filter: "blur(5px)", pathLength: 1, pathOffset: 0}}
