          ...
          <div className="block md:hidden relative">
                ...
                <div className="relative w-full h-full flex items-center justify-center">
                    ...
                    <div className={`${mplus.className} text-stone-300 absolute inset-0  pointer-events-none z-30`}>
                      ...
                      <h4 className="absolute text-left text-2xl sm:text-4xl bottom-[8%] left-[19%]"><BounceEffect delay={1.4}><span className="text-sm sm:text-xl">2024年</span><br />フロントエンドエンジニア</BounceEffect></h4>
                    </div>
                </div>
          </div>
          {/*end*/}
